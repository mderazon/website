...
<head>
    ...
    <meta name="twitter:image" content="https://www.drzon.net/images/cover.jpg"/>
...
<span class="nav-cover"></span>
 ...
 <div class="site-wrapper">
  ...
  <header class="main-header tag-head" style="background-image: url(https://www.drzon.net/images/cover.jpg)">
  

    <nav class="main-nav overlay clearfix">
      
        <a class="blog-logo" href="https://www.drzon.net/"><img src="https://www.drzon.net/images/selfie.png" alt="Home" /></a>
...
Simple server Lets start with a simple server:
 We first require express, then we tell express where to look for our templates files. In this case I used ejs as the template engine. I like it because it&rsquo;s syntax is basically html with special &lt;% ... %&gt; syntax for embedding code from the server. <a class="read-more" href="https://www.drzon.net/posts/i18n-for-node-express">&raquo;</a></p>
    ...
    <footer class="post-meta">
            ...
            <img class="author-thumb" src="https://www.drzon.net/images/selfie.png" alt="Author image" nopin="nopin" />
        ...
        on
                ...
                <a href="https://www.drzon.net/tags/node.js/">#node.js</a>,
            
                <a href="https://www.drzon.net/tags/i18n/">#i18n</a>,
            
                <a href="https://www.drzon.net/tags/express/">#express</a>,
